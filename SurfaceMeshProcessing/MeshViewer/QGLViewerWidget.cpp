...
QSize QGLViewerWidget::sizeHint(void) const
{
	...
	// 错误：已弃用的类，使用QGuiApplication::screens()
...
void QGLViewerWidget::WinCor2ObjCor(int x, int y, OpenMesh::Vec3d& objCor, double& depth)
{
	...
	GLdouble objx0, objy0, objz0, objx1, objy1, objz1;//lsb
	makeCurrent();
	glGetIntegerv(GL_VIEWPORT, viewport);
	glReadBuffer(GL_FRONT);
	glReadPixels(x, viewport[3] - y, 1, 1, GL_DEPTH_COMPONENT, GL_FLOAT, &z);
	gluUnProject(x, viewport[3] - y, z, &modelviewmatrix[0], &projectionmatrix[0], viewport, &objx, &objy, &objz);
	gluUnProject(x, viewport[3] - y, 0.0, &modelviewmatrix[0], &projectionmatrix[0], viewport, &objx0, &objy0, &objz0);
	gluUnProject(x, viewport[3] - y, 1.0, &modelviewmatrix[0], &projectionmatrix[0], viewport, &objx1, &objy1, &objz1);
	double t = -objz0 / (objz1 - objz0);
	double intersectX = t * objx1 + (1 - t) * objx0;
	double intersectY = t * objy1 + (1 - t) * objy0;
	depth = z;
	objCor = OpenMesh::Vec3d(intersectX, intersectY, 0);//lsb objz->0
}
...
void QGLViewerWidget::LoadTexture()
{
	...
	//unsigned char* data = stbi_load("../Images/tiling patterns/checkers_zoom.png", &width, &height, &nChannels, 0);
	std::cout << "loading texture" << std::endl;
	//unsigned char* data = stbi_load("../Images/tiling patterns/deer.png", &width, &height, &nChannels, 0);//texture-deer
	//unsigned char* data = stbi_load("../Images/tiling patterns/ball.png", &width, &height, &nChannels, 0);//texture-ball
	unsigned char* data = stbi_load("../Images/tiling patterns/paristower.png", &width, &height, &nChannels, 0);//texture-tower
	//unsigned char* data = stbi_load("../Images/tiling patterns/xiyi.png", &width, &height, &nChannels, 0);//texture-xiyi
	//unsigned char* data = stbi_load("../Images/tiling patterns/yu.png", &width, &height, &nChannels, 0);//texture-yu
	//unsigned char* data = stbi_load("../Images/tiling patterns/kuzi.png", &width, &height, &nChannels, 0);//texture-kuzi
	//unsigned char* data = stbi_load("../Images/tiling patterns/car.png", &width, &height, &nChannels, 0);//texture-car
	...
	//unsigned char* data = stbi_load("../Images/tiling patterns/tuzi.png", &width, &height, &nChannels, 0);//tuzi
	//unsigned char* data = stbi_load("../Images/tiling patterns/daizi.png", &width, &height, &nChannels, 0);//daizi
	//unsigned char* data = stbi_load("../Images/tiling patterns/Zebrafish.png", &width, &height, &nChannels, 0);//fish
	//unsigned char* data = stbi_load("../Images/tiling patterns/giraffe.png", &width, &height, &nChannels, 0);//giraffe
	//unsigned char* data = stbi_load("../Images/tiling patterns/02.png", &width, &height, &nChannels, 0);//zhengfangxin
	//unsigned char* data = stbi_load("../Images/tiling patterns/choufish1.png", &width, &height, &nChannels, 0);//choufish1
	//unsigned char* data = stbi_load("../Images/tiling patterns/zoom_fish.png", &width, &height, &nChannels, 0);//zoom_fish
	//unsigned char* data = stbi_load("../Images/tiling patterns/circle1.png", &width, &height, &nChannels, 0);//circle
	//unsigned char* data = stbi_load("../Images/tiling patterns/human.png", &width, &height, &nChannels, 0);//human
	//unsigned char* data = stbi_load("../Images/tiling patterns/flower.png", &width, &height, &nChannels, 0);//flower
	//unsigned char* data = stbi_load("../Images/tiling patterns/octopus.png", &width, &height, &nChannels, 0);//octopus
	//unsigned char* data = stbi_load("../Images/tiling patterns/sheji1_curve.png", &width, &height, &nChannels, 0);//sheji
	//unsigned char* data = stbi_load("../Images/tiling patterns/pangxie1.png", &width, &height, &nChannels, 0);//pangxie
	//unsigned char* data = stbi_load("../Images/tiling patterns/haixing1.png", &width, &height, &nChannels, 0);//texture-haixing
	//unsigned char* data = stbi_load("../Images/tiling patterns/texture_mine1.png", &width, &height, &nChannels, 0);//texture_mine
	//unsigned char* data = stbi_load("../Images/tiling patterns/texture_mine.png", &width, &height, &nChannels, 0);//texture_mine,无边
	//unsigned char* data = stbi_load("../Images/tiling patterns/fengzheng.png", &width, &height, &nChannels, 0);//fengzheng
	//unsigned char* data = stbi_load("../Images/tiling patterns/xiyi.png", &width, &height, &nChannels, 0);//xiyi
	//unsigned char* data = stbi_load("../Images/tiling patterns/dol.png", &width, &height, &nChannels, 0);//dol
	//unsigned char* data = stbi_load("../Images/tiling patterns/chong.png", &width, &height, &nChannels, 0);//chong
	//unsigned char* data = stbi_load("../Images/tiling patterns/yezi.png", &width, &height, &nChannels, 0);//yezi
	//unsigned char* data = stbi_load("../Images/tiling patterns/hat.png", &width, &height, &nChannels, 0);//hat
	//unsigned char* data = stbi_load("../Images/tiling patterns/seahorse.png", &width, &height, &nChannels, 0);//seahorse
	//unsigned char* data = stbi_load("../Images/tiling patterns/jinglin.png", &width, &height, &nChannels, 0);//jinglin
	//unsigned char* data = stbi_load("../Images/tiling patterns/tree.png", &width, &height, &nChannels, 0);//tree
	//unsigned char* data = stbi_load("../Images/tiling patterns/sheji.png", &width, &height, &nChannels, 0);//sheji
	//unsigned char* data = stbi_load("../Images/tiling patterns/sharp.png", &width, &height, &nChannels, 0);//sharp
	//unsigned char* data = stbi_load("../Images/tiling patterns/zimu_S.png", &width, &height, &nChannels, 0);//texture-S
	//unsigned char* data = stbi_load("../Images/tiling patterns/GreenCube.png", &width, &height, &nChannels, 0);//texture-S
	//unsigned char* data = stbi_load("../Images/tiling patterns/elephant.png", &width, &height, &nChannels, 0);//elephant
	//unsigned char* data = stbi_load("../Images/tiling patterns/rainbow.png", &width, &height, &nChannels, 0);//rainbow
	std::cout << width << "height" << height << std::endl;
